import pickle         # use for loading and serializing
import streamlit as st
from streamlit_option_menu import option_menu

# load save model
diabetes_model = pickle.load(open('D:\ml\project\disease\predict\diabetes_model.sav','rb'))
heart_disease_model = pickle.load(open('D:\ml\project\disease\predict\heart_disease_model.sav','rb'))
parkinson_model = pickle.load(open('D:\ml\project\disease\predict\parkinson_model.sav','rb'))
